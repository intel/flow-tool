...
/**Plugin specific : discovery plugin*/
#define COLLECT_STATUS "collect"
#define DISCOVERY_OUTPUT_FILE "/usr/share/kit/json/output/platform-snapshot.json"
#define DISCOVERY_CONFIG_FILE "/usr/share/kit/json/snapshot_config.json"

/**Plugin specific : deploy plugin*/
#define DEPLOY_STATUS "deploy"

/**Plugin specific : analysis plugin*/
#define ANALYSIS_STATUS "analysis"
